use bevy::prelude::*;
use crate::{PLAYER_LAYER, assets::LoadedAssets, PLAYER_BULLET_LAYER, movement::*, AppState, BULLET_LAYER};

// weapon modules
mod missile; use missile::*;
...
impl Plugin for PlayerPlugin {
    fn build(&self, app: &mut App) {
        app
            ...
            .add_system(player_launch_missile.in_set(OnUpdate(AppState::InGame)))
            .add_system(missile_move.in_set(OnUpdate(AppState::InGame)))
        ;
    }
}
...
fn spawn_player(
    ...
    commands.spawn(
        ...
        .insert(MissileLauncher { timer: Timer::from_seconds(2., TimerMode::Once)} )
